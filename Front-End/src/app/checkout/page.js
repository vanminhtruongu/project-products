            ...
            <div className="p-6 sm:p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-500"
                    />
                    <label htmlFor="e_wallet" className="ml-3 block text-sm font-medium text-gray-700">
                      Ví điện tử
                    </label>
                  </div>
                </div>
              ...
              <div className="mt-8 space-y-4 sm:space-y-0 sm:flex sm:justify-end sm:space-x-4">
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
                >
                  Quay lại giỏ hàng
                </button>
                <button
                  ...
                  className={`w-full sm:w-auto px-6 py-3 text-sm font-medium text-white bg-blue-600 rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200
